...
public class OproductDetail  {
    ...
    private String mDealerPayments;
    ...
    OproductDetail(Image RequestedImage, String requestedPname,String price ,String status,int Pcount){
    ...
    OproductDetail(Image pay, String PaymentsLeft,String PaymentsDone ,int ProductNumber ){
        mpaymentImage=pay;
    ...
    OproductDetail(Image Dealerimage, String DealerName , String phoneNumber,String address,String paymentsLeft){
        mDealerName=DealerName;
        mdealerImage=Dealerimage;
        mPhoneNumber=phoneNumber;
        mDealerAddress=address;
        mDealerPayments=paymentsLeft;

    }
    OproductDetail(Image image, String productName , String price,String mProductNumber,int i,int j){
        mImage=image;
        mPrice=price;
    ...
    public String getmDealerPayments() {
        return mDealerPayments;
    }
